...
class lane(genpy.Message):
  _md5sum = "3c63bd29455064c5c0c6658b234a2e48"
...
uint64 event_state
"""
  __slots__ = ['header','increment','lane_id','waypoints']
  _slot_types = ['std_msgs/Header','int32','int32','autoware_msgs/waypoint[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,increment,lane_id,waypoints
