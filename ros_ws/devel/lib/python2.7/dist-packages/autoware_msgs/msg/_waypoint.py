...
class waypoint(genpy.Message):
  _md5sum = "f42e6a8fdd936a989d454b327851bb01"
...
uint64 event_state
"""
  __slots__ = ['gid','lid','pose','twist','dtlane','change_flag','wpstate']
  _slot_types = ['int32','int32','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','autoware_msgs/dtlane','int32','autoware_msgs/WaypointState']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       gid,lid,pose,twist,dtlane,change_flag,wpstate
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_14d2i4BQ = None
def _get_struct_14d2i4BQ():
    global _struct_14d2i4BQ
    if _struct_14d2i4BQ is None:
        _struct_14d2i4BQ = struct.Struct("<14d2i4BQ")
    return _struct_14d2i4BQ
_struct_2i3I = None
