...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ConfigApproximateNdtMapping>)))
  ...
  "cd51ec722a1cf5fdf0e28e70055fb245")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ConfigApproximateNdtMapping)))
  "Returns md5sum for a message object of type 'ConfigApproximateNdtMapping"
  "cd51ec722a1cf5fdf0e28e70055fb245")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConfigApproximateNdtMapping>)))
  ...
  (cl:format cl:nil "Header header~%float32 resolution~%float32 step_size~%float32 trans_epsilon~%int32 max_iterations~%float32 leaf_size~%float32 min_scan_range~%float32 min_add_scan_shift~%float32 max_submap_size~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConfigApproximateNdtMapping)))
  "Returns full string definition for message of type 'ConfigApproximateNdtMapping"
  (cl:format cl:nil "Header header~%float32 resolution~%float32 step_size~%float32 trans_epsilon~%int32 max_iterations~%float32 leaf_size~%float32 min_scan_range~%float32 min_add_scan_shift~%float32 max_submap_size~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
