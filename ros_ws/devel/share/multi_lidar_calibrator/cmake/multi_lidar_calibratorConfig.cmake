...
if("TRUE" STREQUAL "TRUE")
  set(multi_lidar_calibrator_SOURCE_PREFIX /root/ros_ws/src/multi_lidar_calibrator)
  set(multi_lidar_calibrator_DEVEL_PREFIX /root/ros_ws/devel)
  ...
  set(multi_lidar_calibrator_INSTALL_PREFIX /root/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_lidar_calibrator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_ws/src/multi_lidar_calibrator/${idir}'.  ${_report}")
    endif()
